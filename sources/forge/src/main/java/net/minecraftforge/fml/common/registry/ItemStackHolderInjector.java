...
public enum ItemStackHolderInjector
{
    ...
    public void inject() {
        FMLLog.log.debug("Injecting itemstacks"); // Akarin - down to debug
        for (ItemStackHolderRef ishr: itemStackHolders) {
            ishr.apply();
        }
        FMLLog.log.debug("Itemstack injection complete"); // Akarin - down to debug
    }

    public void findHolders(ASMDataTable table) {
        FMLLog.log.debug("Identifying ItemStackHolder annotations"); // Akarin - down to debug
        ...
        FMLLog.log.debug("Found {} ItemStackHolder annotations", allItemStackHolders.size()); // Akarin - down to debug
