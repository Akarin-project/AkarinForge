...
public enum ObjectHolderRegistry
{
    ...
    {
        FMLLog.log.debug("Processing ObjectHolder annotations"); // Akarin - down to debug
        ...
        FMLLog.log.debug("Found {} ObjectHolder annotations", objectHolders.size()); // Akarin - down to debug
    }
    ...
    {
        FMLLog.log.debug("Applying holder lookups"); // Akarin - down to debug
        for (ObjectHolderRef ohr : objectHolders)
        {
            ohr.apply();
        }
        FMLLog.log.debug("Holder lookups applied"); // Akarin - down to debug
    }
