...
public final class VanillaCommandWrapper extends BukkitCommand {
    ...
    public VanillaCommandWrapper(ICommand cmd, String usage) {
        super(cmd.getName(), "A Mojang provided command.", usage, cmd.getAliases());
        this.vanillaCommand = cmd;
        this.setPermission("minecraft.command." + cmd.getName());
    }
    ...
    public List<String> tabComplete(CommandSender sender, String alias, String[] args, Location location) throws IllegalArgumentException {
        ...
        return (List<String>) vanillaCommand.getTabCompletions(MinecraftServer.instance(), getListener(sender), args, (location) == null ? null : new BlockPos(location.getX(), location.getY(), location.getZ()));
    }
    ...
    public final int dispatchVanillaCommand(CommandSender bSender, ICommandSender icommandlistener, String[] as) throws CommandException {
        ...
        WorldServer[] prev = MinecraftServer.instance().worlds;
        MinecraftServer server = MinecraftServer.instance();
        // server.worlds = new WorldServer[server.worlds.length]; // Akarin
        ...
        try {
            ...
            MinecraftServer.instance().worlds = prev;
        }
        return j;
    }
