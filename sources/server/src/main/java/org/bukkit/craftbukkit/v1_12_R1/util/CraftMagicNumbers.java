...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public Statistic getStatisticFromInternalName(String name) {
        return org.bukkit.craftbukkit.v1_12_R1.CraftStatistic.getBukkitStatisticByName(name);
    }
    ...
    public Advancement loadAdvancement(NamespacedKey key, String advancement) {
        ...
        if (nms != null) {
            ...
            if (bukkit != null) {
                File file = new File(MinecraftServer.instance().getAdvancementManager().advancementsDir, key.getNamespace() + File.separator + key.getKey() + ".json");
                ...
                MinecraftServer.instance().getPlayerList().reloadResources();
