...
public class Chunk implements net.minecraftforge.common.capabilities.ICapabilityProvider
{
    ...
    // Akarin start - Neighbor loaded cache for chunk lighting and entity ticking
    ...
    public Chunk(World worldIn, int x, int z)
    {
        ...
        this.world = worldIn;
        this.bukkitChunk = new org.bukkit.craftbukkit.v1_12_R1.CraftChunk(this); // Akarin
        this.x = x;
        this.z = z;
    ...
    public void addTileEntity(BlockPos pos, TileEntity tileEntityIn)
    {
        ...
        if (this.getBlockState(pos).getBlock().hasTileEntity(this.getBlockState(pos)))
        {
            ...
            try {
                ...
                FMLLog.log.warn("Failed to place a tile entity at {} with name {}.", pos, tileEntityIn.getClass().getSimpleName());
                return;
            }
    ...
    protected void populate(IChunkGenerator generator)
    {
        ...
        else
        {
            ...
            if (!AkarinForge.disableForgeGenWorld.contains(world.getName())) {
