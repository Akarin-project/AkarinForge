...
public class ContainerRepair extends Container
{
    ...
    public void updateRepairOutput()
    {
        ...
        {
            org.bukkit.craftbukkit.v1_12_R1.event.CraftEventFactory.callPrepareAnvilEvent(getBukkitView(), ItemStack.EMPTY); // CraftBukkit
            this.maximumCost = 0;
        }
        else
        {
            ...
            org.bukkit.craftbukkit.v1_12_R1.event.CraftEventFactory.callPrepareAnvilEvent(getBukkitView(), itemstack1); // CraftBukkit
