...
public class PlayerAdvancements
{
    ...
    public boolean grantCriterion(Advancement p_192750_1_, String p_192750_2_)
    {
        ...
        if (advancementprogress.grantCriterion(p_192750_2_))
        {
            ...
            {
            	MinecraftServer.instance().server.getPluginManager().callEvent(new org.bukkit.event.player.PlayerAdvancementDoneEvent(this.player.getBukkitEntity(), p_192750_1_.bukkit)); // Akarin
