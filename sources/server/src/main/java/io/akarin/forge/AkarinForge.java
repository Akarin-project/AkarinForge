...
public class AkarinForge {
    ...
    public static void loadConfig() {
        ...
        fakePlayerPermissions = getOrWriteStringListConfig("fakePlayer.permissions", Collections.singletonList("essentials.build"));
    }
    ...
    static {
        ...
        fileIOThread = new ThreadPoolExecutor(1, 2, 30, TimeUnit.SECONDS, new DisruptorBlockingQueue<Runnable>(64));
        if (buildTime == 0) {
