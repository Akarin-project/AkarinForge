...
public class BlockConcretePowder extends BlockFalling
{
    ...
    protected boolean tryTouchWater(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (flag)
        {
            CraftEventFactory.handleBlockFormEvent(worldIn, pos, Blocks.CONCRETE.getDefaultState().withProperty(BlockColored.COLOR, state.getValue(BlockConcretePowder.COLOR)), null); // CraftBukkit
        }
