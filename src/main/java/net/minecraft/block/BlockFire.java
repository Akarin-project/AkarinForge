...
public class BlockFire extends Block
{
    ...
    {
        this.tryCatchFire(worldIn, pos, chance, random, age, EnumFacing.UP, pos.down()); // Akarin
    }
    
    private void tryCatchFire(World worldIn, BlockPos pos, int chance, Random random, int age, EnumFacing face, BlockPos sourceposition) { // CraftBukkit add sourceposition
    {
        ...
        if (random.nextInt(chance) < i)
        {
            ...
            org.bukkit.block.Block sourceBlock = worldIn.getWorld().getBlockAt(sourceposition.getX(), sourceposition.getY(), sourceposition.getZ());
