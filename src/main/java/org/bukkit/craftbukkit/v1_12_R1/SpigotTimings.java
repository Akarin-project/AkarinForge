...
public class SpigotTimings {
    ...
    public static CustomTimingsHandler getEntityTimings(vg entity) {
    ...
    public static CustomTimingsHandler getTileEntityTimings(avj entity) {
        String entityType = entity.getClass().getName();
    ...
    public static class WorldTimingsHandler {
        ...
        public WorldTimingsHandler(amu server) {
