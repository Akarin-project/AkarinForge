...
public enum CraftSound {
    ...
    private CraftSound(String minecraftKey) {
        this.minecraftKey = minecraftKey;
    }

    public static String getSound(Sound sound) {
        Validate.notNull((Object)((Object)sound), (String)"Sound cannot be null", (Object[])new Object[0]);
        return CraftSound.valueOf((String)sound.name()).minecraftKey;
    }

    public static SoundEvent getSoundEffect(String s2) {
        SoundEvent effect = SoundEvent.REGISTRY.getObject(new ResourceLocation(s2));
        Preconditions.checkArgument((boolean)(effect != null), (String)"Sound effect %s does not exist", (Object)s2);
        return effect;
    }
}
