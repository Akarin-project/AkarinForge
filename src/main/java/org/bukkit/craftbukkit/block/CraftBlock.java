...
public class CraftBlock implements Block {
    ...
    public static Biome biomeBaseToBiome(net.minecraft.world.biome.Biome biome) {
        if (biome == null) {
            return null;
        }

        return Biome.valueOf(net.minecraft.world.biome.Biome.REGISTRY.getNameForObject(biome).getResourcePath().toUpperCase(java.util.Locale.ENGLISH));
    }
